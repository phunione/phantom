...
const actorOptions = await getOptions('actor'),
  ...
  bankerEmployeeOptions = await getOptions('banker_employee'),
  companyOptions = await getOptions('company'),
  idOptions = await getOptions('id')
...
const fields = {
  actor: [
    ...
    },
    {
      ...
      required: false,
      type: 'select',
      options: ['Select Id Type', 'prop', 'only aadhar', 'dummy', 'aadhar otp'],
    },
  ],
  bank: [
    {
