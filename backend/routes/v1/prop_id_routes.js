...
prop_id_router.post("/add",addUsertoProp)//add middleware to check the permissions

prop_id_router.get("/get",get_prop_users)//add middleware to check the permissions

prop_id_router.put("/addactor",addActorToPropId)//add middleware to check the permissions

prop_id_router.put("/edit/:id",update_prop_details)//add middleware to check the permissions
