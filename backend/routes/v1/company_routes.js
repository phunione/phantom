...
import {post_company, get_companies,get_company_id,delete_company,adfs,update_compnay_from_id} from '../../controllers/company_controller.js'
...
CompanyRouter.put('/edit/:id',update_compnay_from_id);
